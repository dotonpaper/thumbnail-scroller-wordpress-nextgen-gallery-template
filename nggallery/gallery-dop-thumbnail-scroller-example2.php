...
<script type="text/JavaScript">
    var DOPNextGENThumbnailScrollerSettings<?php echo $gallery->ID;?> = {
        "Width": 900, // Width (value in pixels). Default value: 900. Set the width of the scroller.
        "Height": 147, // Height (value in pixels). Default value: 128. Set the height of the scroller.")
        "BgColor": "c0c0c0", // Background Color (color hex code). Default value: ffffff. Set scroller background color.
        "BgAlpha": 100, // Background Alpha (value from 0 to 100). Default value: 100. Set scroller alpha.
        "BgBorderSize": 3, // Background Border Size (value in pixels). Default value: 1. Set the size of the scroller border.
        "BgBorderColor": "eeeeee", // Background Border Color (color hex code). Default value: e0e0e0. Set the color of the scroller border.
        ...
        "ThumbnailsBgColor": "c0c0c0", // Thumbnails Background Color (color hex code). Default value: ffffff. Set the color for the thumbnails background.
        ...
        "ThumbnailsScrollScrubColor": "707070", // Thumbnails Scroll Scrub Color (color hex code). Default value: 808080. Set the scroll scrub color.
        ...
        "ThumbnailsNavigationPrev": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsPrev2.png", // Thumbnails Navigation Previous Button Image (path to image). Upload the image for thumbnails navigation's previous button.
        "ThumbnailsNavigationPrevHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsPrevHover2.png", // Thumbnails Navigation Previous Button Hover Image (path to image). Upload the image for thumbnails navigation's previous hover button.
        "ThumbnailsNavigationPrevDisabled": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsPrevDisabled2.png", // Thumbnails Navigation Previous Button Disabled Image (path to image). Upload the image for thumbnails navigation's previous disabled button.
        "ThumbnailsNavigationNext": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsNext2.png", // Thumbnails Navigation Next Button Image (path to image). Upload the image for thumbnails navigation's next button.
        "ThumbnailsNavigationNextHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsNextHover2.png", // Thumbnails Navigation Next Button Hover Image (path to image). Upload the image for thumbnails navigation's next hover button.
        "ThumbnailsNavigationNextDisabled": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsNextDisabled2.png", // Thumbnails Navigation Next Button Disabled Image (path to image). Upload the image for thumbnails navigation's next disabled button.
        ...
        "ThumbnailBgColor": "606060", // Thumbnail Background Color (color hex code). Default value: f1f1f1. Set the color of a thumbnail's background.
        "ThumbnailBgColorHover": "202020", // Thumbnail Background Color Hover (color hex code). Default value: f1f1f1. Set the color of a thumbnail's background when hover.
        "ThumbnailBorderSize": 0, // Thumbnail Border Size (value in pixels). Default value: 1. Set the size of a thumbnail's border.
        "ThumbnailBorderColor": "c0c0c0", // Thumbnail Border Color (color hex code). Default value: d0d0d0. Set the color of a thumbnail's border.
        "ThumbnailBorderColorHover": "000000", // Thumbnail Border Color Hover (color hex code). Default value: 303030. Set the color of a thumbnail's border when hover.
        "ThumbnailPaddingTop": 3, // Thumbnail Padding Top (value in pixels). Default value: 2. Set top padding value of a thumbnail.
        "ThumbnailPaddingRight": 3, // Thumbnail Padding Right (value in pixels). Default value: 2. Set right padding value of a thumbnail.
        "ThumbnailPaddingBottom": 3, // Thumbnail Padding Bottom (value in pixels). Default value: 2. Set bottom padding value of a thumbnail.
        "ThumbnailPaddingLeft": 3, // Thumbnail Padding Left (value in pixels). Default value: 2. Set left padding value of a thumbnail.
        ...
        "LightboxWindowColor": "f0f0f0", // Lightbox Window Color (color hex code). Default value: ffffff. Set the color for the lightbox window.
        ...
        "LightboxBgColor": "606060", // Lightbox Background Color (color hex code). Default value: ffffff. Set the color for the lightbox background.
        ...
        "LightboxNavigationPrev": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxPrev2.png", // Lightbox Navigation Previous Button Image (path to image). Upload the image for lightbox navigation's previous button.
        "LightboxNavigationPrevHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxPrevHover2.png", // Lightbox Navigation Previous Button Hover Image (path to image). Upload the image for lightbox navigation's previous hover button.
        "LightboxNavigationNext": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxNext2.png", // Lightbox Navigation Next Button Image (path to image). Upload the image for lightbox navigation's next button.
        "LightboxNavigationNextHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxNextHover2.png", // Lightbox Navigation Next Button Hover Image (path to image). Upload the image for lightbox navigation's next hover button.
        "LightboxNavigationClose": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxClose2.png", // Lightbox Navigation Close Button Image (path to image). Upload the image for lightbox navigation's close button.
        "LightboxNavigationCloseHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxCloseHover2.png", // Lightbox Navigation Close Button Hover Image (path to image). Upload the image for lightbox navigation's close hover button.
        "LightboxNavigationInfoBgColor": "606060", // Lightbox Navigation Info Background Color (color hex code). Default value: ffffff. Set the color for the lightbox info background.
        "LightboxNavigationInfoTextColor": "e0e0e0", // Lightbox Navigation Info Text Color (color hex code). Default value: c0c0c0. Set the color for the lightbox info text.
        ...
        "SocialShareLightbox": "dopts/assets/gui/images/SocialShareLightbox.png", // Lightbox Social Share Button Image (path to image). Upload the image for lightbox social share button.
        "SocialShareEnabled": "true", // Social Share Enabled (true, false). Default value: true. Enable AddThis Social Share.
        "SocialShareLightbox": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/SocialShareLightbox2.png", // Lightbox Social Share Button Image (path to image). Upload the image for lightbox social share button.
