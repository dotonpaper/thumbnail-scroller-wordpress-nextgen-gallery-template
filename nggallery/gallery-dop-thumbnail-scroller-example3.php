...
<script type="text/JavaScript">
    var DOPNextGENThumbnailScrollerSettings<?php echo $gallery->ID;?> = {
        ...
        "Height": 238, // Height (value in pixels). Default value: 128. Set the height of the scroller.")
        "BgColor": "000000", // Background Color (color hex code). Default value: ffffff. Set scroller background color.
        ...
        "BgBorderColor": "000000", // Background Border Color (color hex code). Default value: e0e0e0. Set the color of the scroller border.
        ...
        "ThumbnailsBgColor": "000000", // Thumbnails Background Color (color hex code). Default value: ffffff. Set the color for the thumbnails background.
        ...
        "ThumbnailsSpacing": 9, // Thumbnails Spacing (value in pixels). Default value: 10. Set the space between thumbnails.
        ...
        "ThumbnailsScrollSize": 7, // Thumbnails Scroll Size (value in pixels). Default value: 5. Set the scroll size color.
        "ThumbnailsScrollScrubColor": "afbd21", // Thumbnails Scroll Scrub Color (color hex code). Default value: 808080. Set the scroll scrub color.
        "ThumbnailsScrollBarColor": "606060", // Thumbnails Scroll Bar Color (color hex code). Default value: e0e0e0. Set the scroll bar color.
        ...
        "ThumbnailsNavigationArrowsNoItemsSlide": 3, // Thumbnails Navigation Arrows Number Items Slide (number of thumbnails). Default value: 1. The number of thumbnails that will slide when you click the arrows.
        ...
        "ThumbnailsNavigationPrev": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsPrev3.png", // Thumbnails Navigation Previous Button Image (path to image). Upload the image for thumbnails navigation's previous button.
        "ThumbnailsNavigationPrevHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsPrevHover3.png", // Thumbnails Navigation Previous Button Hover Image (path to image). Upload the image for thumbnails navigation's previous hover button.
        "ThumbnailsNavigationPrevDisabled": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsPrevDisabled3.png", // Thumbnails Navigation Previous Button Disabled Image (path to image). Upload the image for thumbnails navigation's previous disabled button.
        "ThumbnailsNavigationNext": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsNext3.png", // Thumbnails Navigation Next Button Image (path to image). Upload the image for thumbnails navigation's next button.
        "ThumbnailsNavigationNextHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsNextHover3.png", // Thumbnails Navigation Next Button Hover Image (path to image). Upload the image for thumbnails navigation's next hover button.
        "ThumbnailsNavigationNextDisabled": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailsNextDisabled3.png", // Thumbnails Navigation Next Button Disabled Image (path to image). Upload the image for thumbnails navigation's next disabled button.
        "ThumbnailLoader": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailLoader3.gif", // Thumbnail Loader (path to image). Set the loader for the thumbnails.
        "ThumbnailWidth": 262, // Thumbnail Width (the size in pixels). Default value: 100. Set the width of a thumbnail.
        "ThumbnailHeight": 200, // Thumbnail Height (the size in pixels). Default value: 100. Set the height of a thumbnail.
        "ThumbnailAlpha": 90, // Thumbnail Alpha (value from 0 to 100). Default value: 100. Set the transparency of a thumbnail.
        ...
        "ThumbnailBgColorHover": "000000", // Thumbnail Background Color Hover (color hex code). Default value: f1f1f1. Set the color of a thumbnail's background when hover.
        "ThumbnailBorderSize": 0, // Thumbnail Border Size (value in pixels). Default value: 1. Set the size of a thumbnail's border.
        ...
        "ThumbnailPaddingTop": 0, // Thumbnail Padding Top (value in pixels). Default value: 2. Set top padding value of a thumbnail.
        "ThumbnailPaddingRight": 0, // Thumbnail Padding Right (value in pixels). Default value: 2. Set right padding value of a thumbnail.
        "ThumbnailPaddingBottom": 0, // Thumbnail Padding Bottom (value in pixels). Default value: 2. Set bottom padding value of a thumbnail.
        "ThumbnailPaddingLeft": 0, // Thumbnail Padding Left (value in pixels). Default value: 2. Set left padding value of a thumbnail.
        ...
        "LightboxWindowColor": "000000", // Lightbox Window Color (color hex code). Default value: ffffff. Set the color for the lightbox window.
        ...
        "LightboxLoader": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxLoader3.gif", // Lightbox Loader (path to image). Set the loader for the lightbox image.
        "LightboxBgColor": "202020", // Lightbox Background Color (color hex code). Default value: ffffff. Set the color for the lightbox background.
        ...
        "LightboxBorderSize": 2, // Lightbox Border Size (value in pixels). Default value: 1. Set the size of a lightbox's border.
        "LightboxBorderColor": "000000", // Lightbox Border Color (color hex code). Default value: e0e0e0. Set the color of a lightbox's border.
        ...
        "LightboxNavigationPrev": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxPrev3.png", // Lightbox Navigation Previous Button Image (path to image). Upload the image for lightbox navigation's previous button.
        "LightboxNavigationPrevHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxPrevHover3.png", // Lightbox Navigation Previous Button Hover Image (path to image). Upload the image for lightbox navigation's previous hover button.
        "LightboxNavigationNext": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxNext3.png", // Lightbox Navigation Next Button Image (path to image). Upload the image for lightbox navigation's next button.
        "LightboxNavigationNextHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxNextHover3.png", // Lightbox Navigation Next Button Hover Image (path to image). Upload the image for lightbox navigation's next hover button.
        "LightboxNavigationClose": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxClose3.png", // Lightbox Navigation Close Button Image (path to image). Upload the image for lightbox navigation's close button.
        "LightboxNavigationCloseHover": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxCloseHover3.png", // Lightbox Navigation Close Button Hover Image (path to image). Upload the image for lightbox navigation's close hover button.
        "LightboxNavigationInfoBgColor": "202020", // Lightbox Navigation Info Background Color (color hex code). Default value: ffffff. Set the color for the lightbox info background.
        "LightboxNavigationInfoTextColor": "ffffff", // Lightbox Navigation Info Text Color (color hex code). Default value: c0c0c0. Set the color for the lightbox info text.
        ...
        "SocialShareLightbox": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/SocialShareLightbox3.png", // Lightbox Social Share Button Image (path to image). Upload the image for lightbox social share button.
        ...
        "LabelPosition": "top", // Label Position (bottom, top, under). Default value: bottom. Set label position.
