...
<script type="text/JavaScript">
    var DOPNextGENThumbnailScrollerSettings<?php echo $gallery->ID;?> = {
        ...
        "Height": 263, // Height (value in pixels). Default value: 128. Set the height of the scroller.")
        ...
        "ThumbnailsSpacing": 5, // Thumbnails Spacing (value in pixels). Default value: 10. Set the space between thumbnails.
        ...
        "ThumbnailsNavigationLoop": "true", // Enable Thumbnails Loop (true, false). Default value: false. Enable thumbnails loop ... scroll will be disabled.
        ...
        "ThumbnailWidth": 118, // Thumbnail Width (the size in pixels). Default value: 100. Set the width of a thumbnail.
        ...
        "LabelPosition": "under", // Label Position (bottom, top, under). Default value: bottom. Set label position.
        "LabelAlwaysVisible": "true",// Label Always Visible (true, false). Default value: false. On true the label is always visible, on false it will be visible only on hover.
        "LabelUnderHeight": 55,// Height for Under Label (the size in pixels). Default value: 50. Set the height only for the label under a thumbnail.
        "LabelBgColor": "000000", // Label Position (bottom, top). Default value: bottom. Set label position.
        "LabelBgAlpha": 100, // Label Background Alpha (value from 0 to 100). Default value: 80. Set label background transparency.
